...
class TestSQLSessionAPI(unittest.TestCase):
  ...
  def test_create_and_read(self):
      ...
      assert self.session.read_value(User, name="Kesler")[0].public_attributes == new_user.public_attributes
  ...
  def test_update(self):
      ...
      new_user.name = "Paul"
      assert self.session.read_value(User, name="Paul")[0].public_attributes == new_user.public_attributes
